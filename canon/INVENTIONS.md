...
## INV-1220 — the observation rooms' wall plate is the corridor's wall plate
...
## INV-1221 — the bolt pitch is the plate module quartered
...
## INV-1222 — per-plate variation is WHICH measured material, not a jittered one
...
## INV-1223 — nothing deposits on an underside, and the bound is one plate edge
...
## INV-1224 — four authored devices, one written figure per banner
