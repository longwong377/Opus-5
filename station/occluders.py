...
def write_scene(path, verts, tris, head, by="station/occluders.py --emit"):
    ...
    with open(path, "w", encoding="utf-8") as f:
        ...
        # `by` NAMES THE CALLER, so one writer does not cost accurate
        # provenance: two builders emit these and a reader needs to know which
        # one made the file in front of them.
        f.write("; THE CORRIDOR'S OWN WALLS, AS AN OCCLUDER. Generated by\n"
                f"; {by}; do not hand-edit.\n"
                ";\n"
